...
<head>
    <title>Explore | Food friends corner'</title>
</head>
...
<body>
    ...
    <div class="jumbotron">
        <div class="container text-center">
            <h1>Welcome To Friends Corner</h1>
        </div>
    </div>
        ...
        ?>
                <div class="col-md-3">
                    ...
                    <form method="post" action="cart.php?action=add&id=<?php echo $row["F_ID"]; ?>">
                        <div class="mypanel" style="border: 2px solid #ccc; border-radius: 10px; padding: 10px; margin-bottom: 20px;">
                            <img style="width: 200px; height: 200px; object-fit: cover; border-radius: 5px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);" src="<?php echo $row["images_path"]; ?>" class="img-responsive" alt="<?php echo $row["name"]; ?>">
                            <h4 class="text-dark mt-2"><?php echo $row["name"]; ?></h4>
                            <h5 class="text-info"><?php echo $row["description"]; ?></h5>
                            <h5 class="text-danger">Rs.<?php echo $row["price"]; ?>/-</h5>
                            <div class="input-group mt-2">
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-outline-primary btn-number" onclick="updateQuantity('minus', this.parentNode.nextElementSibling)">+
                                        <span class="fa fa-minus"></span>
                                    </button>
                                </span>
                                <input type="text" name="quantity" class="form-control input-number" value="1" min="1" max="25">
                                <span class="input-group-btn">
                                    <button type="button" class="btn btn-outline-primary btn-number" onclick="updateQuantity('plus', this.parentNode.previousElementSibling)">-
                            ...
                            <button type="submit" name="add" class="btn btn-success mt-2" style="width: 100%;">Add to Cart</button>
                        </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        closeFloatingButton.addEventListener("click", function() {
            floatingAdvertisement.style.display = "none";
        });
    });
    ...
    function updateQuantity(action, inputField) {
        ...
        if (action === 'minus') {
            ...
            currentValue = currentValue < 25 ? currentValue + 1 : 25;
        }
